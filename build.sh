...
# Copy Simplified Chinese localization (中文版)
if [ -f "Localization/zh-Hans.lproj/Localizable.strings" ]; then
    cp "Localization/zh-Hans.lproj/Localizable.strings" "${RESOURCES_DIR}/zh-Hans.lproj/Localizable.strings"
fi
